        ...
        <div className='flex flex-col md:flex-row md:justify-between items-center'>
          ...
          <div className='flex flex-col md:flex-row items-center'>
            <input
              type="text"
              placeholder='Search...'
              className="border border-gray-300 rounded-l-md px-4 py-2 focus:outline-none focus:border-gray-600 flex-grow"
              onChange={(e) => setSearchTerm(e.target.value)}
            />
            <button
              className="bg-red-500 text-white px-4 py-2 rounded-r-md md:ml-2 mt-2 md:mt-0 hover:bg-red-600 focus:outline-none"
